...
public class NetworksCode {
    ...
    public static NetworksCode[] populateNetworksCodes() {
        ...
        return new NetworksCode[] {
                ...
                new NetworksCode("airtel", " Check airtel credit", "*123#", "This service enables you to check your current airtime balance which is available for calls", "tag"),
                ...
                new NetworksCode("airtel", " Transfer airtel airtime", "*901#", "This Airtel service enables you to make airtime transfer to another number. you have to enter the amount to be transfer and the recipient number in the fields provided.After clicking send, this will automatically send an SMS to 432 which will trigger the transaction", "tag"),
                ...
                new NetworksCode("airtel", " To know your airtel phone number", "*121#", "This service enables you to know your Airtel phone number", "tag"),
                ...
                new NetworksCode("9mobile", " Borrow credit", "*665*amt#", "With this service, you can borrow airtime from 9mobile and pay back later./n amt: the amount you want to borrow", "tag"),
                ...
                new NetworksCode("9mobile", " Check credit", "*232#", "This service code enables you to check your current airtime balance available for calls towards all network operators", "tag"),
                ...
                new NetworksCode("glo", " Account balance", "*124*1#", "This service code will give you your account balance", "tag"),
                new NetworksCode("glo", "Glo all data plans", "*777#", "Dialing this code will give you the list of all Glo data plans available on the network which you can then chose from", "tag"),
                ...
                new NetworksCode("mtn", " Please Call Me Back", "*131*1*num#", "This service code allows you request other users to call you back", "ussd"),
